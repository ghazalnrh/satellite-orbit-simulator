...
# Satellite Trajectory & Ground Track Simulation
...
### 📊 Key Results
1. Orbital Dynamics: Precise 2D animation showing velocity and position changes over time.
2. Ground Track Analysis: Visualization of the satellite's "footprint" on the world map, essential for mission planning and coverage analysis.
3. 3D Elliptical Modeling: High-quality 3D render of orbits around Earth, including visualization of inclination, eccentricity, and semi-major axis.
...
![2D Orbit Animation](output/animation.gif)
...
![3D Orbit Visualization](output/orbitalsimulate.jpeg)
